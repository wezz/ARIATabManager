...
If you fork this or create a similar package, configure npm Trusted Publishers on the package page at [npmjs.com](https://www.npmjs.com/package/@wezz/ariatabmanager):

- **Publisher:** GitHub Actions
- **Repository owner:** `wezz`
- **Repository name:** `ARIATabManager`
